...
public class TableExam extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == insert) {// 가입 메뉴아이템 클릭
            ...
            if (cdb.userDelete(obj.toString()) > 0) {
                UserGUI.messageBox(this, "레코드 삭제되었습니다.");
                ...
                UserGUI.messageBox(this, "레코드가 삭제되지 않았습니다.");
            }
            ...
            if (fieldName.trim().equals("ALL")) {// 전체검색
                ...
                if (jtf.getText().trim().equals("")) {
                    UserGUI.messageBox(this, "검색단어를 입력해주세요!");
                    jtf.requestFocus();
                } else {// 검색어를 입력했을경우
                    cdb.getUserSearch(dt, fieldName, jtf.getText());
                    if (dt.getRowCount() > 0)
                        jt.setRowSelectionInterval(0, 0);
                }
            }
